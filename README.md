...
-   [`7.9-129-fde81d1`, `7.9`, `latest`](https://github.com/pabra/docker_awstats/blob/7.9/Dockerfile)
...
-   [`master-135-10512db`, `edge`](https://github.com/pabra/docker_awstats/blob/master/Dockerfile)
